...
<h1 style="margin-left:15px">New Post</h1>
  ...
  <form class="navbar-form navbar-left" role="search" action="addnewpost1.php" method="POST" enctype="multipart/form-data" >
          <!-- <div class="form-group" style="margin-left: 380px; margin-top: 50px;"> -->
          <label class="active" style="color: white">Post Title</label><br>
          <input type="text" class="form-control" placeholder="Enter your Posttitle" style="width: 190%; background: transparent;" name="posttitle"> <br>
      
          <label class="active" style="color: white">Image</label><br>
          <input type="file" class="file" placeholder="email" style="width: 190%; height: 190% background: transparent;" name="image"> <br>
      
         
          <label class="active" style="color: white">Category</label><br>
            <select class="form-control" id="sel1"  style="width: 190%;background: transparent; " name="category">
