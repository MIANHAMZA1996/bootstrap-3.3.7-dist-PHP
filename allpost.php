  ...
  <table class="table" style=" background-color: #2D3136;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <img src="uploads/<?php echo $row['image'] ?>" style="height:40px;">
        </td>
        ...
        <td>  
          <div class="btn-group" role="group" aria-label="...">
                <a href="editpost.php?id=<?php echo $row['id'] ?>">  <button type="button" class="btn btn-default">Edit</button></a>
                <a href="deletepost.php?id=<?php echo $row['id'] ?>">  <button type="button" class="btn btn-default">Delete</button></a>
          </div>
        </td>        
      </tr>       
      <?php } ?>
