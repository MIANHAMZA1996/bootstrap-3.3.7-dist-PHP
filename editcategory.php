<?php
  ...
  $id=$_GET['id'];
  $m="SELECT * FROM 4category WHERE id='$id'";
...
<h1 style="margin-left:15px">New Category</h1>
  ...
  <form class="navbar-form navbar-left" role="search" action="updatecategory.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $row->id?>;">
          <!-- <div class="form-group" style="margin-left: 380px; margin-top: 50px;"> -->
          <label class="active" style="color: white">Title</label><br>
          <input type="text" class="form-control" placeholder="Enter your name" style="width: 190%; background: transparent;" value="<?php echo $row->title?>;" name="title"> <br>
      
         

          <label class="active" style="color: white">Category</label><br>
          <input type="text"  class="form-control" placeholder="Category" style=" width: 190%;; background: transparent; " name="category" 
